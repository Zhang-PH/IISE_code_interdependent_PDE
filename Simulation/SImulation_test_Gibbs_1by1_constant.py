...
# IndCP
beta1_hat = np.load('output_constant_simulation/beta1_steady.npy')[-1]
beta2_hat = np.load('output_constant_simulation/beta2_steady.npy')[-1]
beta3_hat = np.load('output_constant_simulation/beta3_steady.npy')[-1]
psi_11_hat = np.load('output_constant_simulation/psi_11_steady.npy')[-1]
psi_12_hat = np.load('output_constant_simulation/psi_12_steady.npy')[-1]
psi_13_hat = np.load('output_constant_simulation/psi_13_steady.npy')[-1]
psi_21_hat = np.load('output_constant_simulation/psi_21_steady.npy')[-1]
psi_22_hat = np.load('output_constant_simulation/psi_22_steady.npy')[-1]
psi_23_hat = np.load('output_constant_simulation/psi_23_steady.npy')[-1]
psi_31_hat = np.load('output_constant_simulation/psi_31_steady.npy')[-1]
psi_32_hat = np.load('output_constant_simulation/psi_32_steady.npy')[-1]
psi_33_hat = np.load('output_constant_simulation/psi_33_steady.npy')[-1]
