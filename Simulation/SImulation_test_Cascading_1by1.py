...
# IndTVP
beta1_hat = np.load('output_cascading/beta1.npy')
beta2_hat = np.load('output_cascading/beta2.npy')
beta3_hat = np.load('output_cascading/beta3.npy')
psi_11_hat = np.load('output_cascading/psi_11.npy')
psi_12_hat = np.load('output_cascading/psi_12.npy')
psi_13_hat = np.load('output_cascading/psi_13.npy')
psi_21_hat = np.load('output_cascading/psi_21.npy')
psi_22_hat = np.load('output_cascading/psi_22.npy')
psi_23_hat = np.load('output_cascading/psi_23.npy')
psi_31_hat = np.load('output_cascading/psi_31.npy')
psi_32_hat = np.load('output_cascading/psi_32.npy')
psi_33_hat = np.load('output_cascading/psi_33.npy')
