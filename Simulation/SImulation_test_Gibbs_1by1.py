...
# IndTVP
beta1_hat = np.load('output_1by1_simulation/beta1_burn.npy')[-1]
beta2_hat = np.load('output_1by1_simulation/beta2_burn.npy')[-1]
beta3_hat = np.load('output_1by1_simulation/beta3_burn.npy')[-1]
...
zeta_ob2 = zeta_cal(psi_21_hat, psi_22_hat, psi_23_hat, T_f_2, X_d_2, X_f_2, beta2_hat, B_psi, B2)
zeta_ob3 = zeta_cal(psi_31_hat, psi_32_hat, psi_33_hat, T_f_3, X_d_3, X_f_3, beta3_hat, B_psi, B3)
