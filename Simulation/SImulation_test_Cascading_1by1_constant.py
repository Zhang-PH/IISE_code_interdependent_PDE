...
# IndCP
beta1_hat = np.load('output_cascading_constant/beta1.npy')
beta2_hat = np.load('output_cascading_constant/beta2.npy')
beta3_hat = np.load('output_cascading_constant/beta3.npy')
psi_11_hat = np.load('output_cascading_constant/theta_11.npy')
psi_12_hat = np.load('output_cascading_constant/theta_12.npy')
psi_13_hat = np.load('output_cascading_constant/theta_13.npy')
psi_21_hat = np.load('output_cascading_constant/theta_21.npy')
psi_22_hat = np.load('output_cascading_constant/theta_22.npy')
psi_23_hat = np.load('output_cascading_constant/theta_23.npy')
psi_31_hat = np.load('output_cascading_constant/theta_31.npy')
psi_32_hat = np.load('output_cascading_constant/theta_32.npy')
psi_33_hat = np.load('output_cascading_constant/theta_33.npy')
...
def zeta_cal(tm1, tm2, tm3, T_f, X_d, X_f, beta, B_mat):
    zeta = (T_f - tm1*X_d - tm2*X_f - tm3*B_mat)@beta
    return zeta

zeta_ob1 = zeta_cal(psi_11_hat, psi_12_hat, psi_13_hat, T_f_1, X_d_1, X_f_1, beta1_hat, B1)
zeta_ob2 = zeta_cal(psi_21_hat, psi_22_hat, psi_23_hat, T_f_2, X_d_2, X_f_2, beta2_hat, B2)
zeta_ob3 = zeta_cal(psi_31_hat, psi_32_hat, psi_33_hat, T_f_3, X_d_3, X_f_3, beta3_hat, B3)
...
print(np.mean(l_test_error_1))
print(np.std(l_test_error_1))
print(np.mean(l_test_error_2))
print(np.std(l_test_error_2))
print(np.mean(l_test_error_3))
print(np.std(l_test_error_3))
print(np.mean(l_test_error))
print(np.std(l_test_error))
print(np.mean(l_test_zeta_1))
print(np.std(l_test_zeta_1))
print(np.mean(l_test_zeta_2))
print(np.std(l_test_zeta_2))
print(np.mean(l_test_zeta_3))
print(np.std(l_test_zeta_3))
print(np.mean(l_test_zeta))
print(np.std(l_test_zeta))
print(np.mean(l_test_total_1))
print(np.std(l_test_total_1))
print(np.mean(l_test_total_2))
print(np.std(l_test_total_2))
print(np.mean(l_test_total_3))
print(np.std(l_test_total_3))
print(np.mean(l_test_total))
print(np.std(l_test_total))