...
psi_11_hat = np.load('output_1by1_simulation/psi_11_burn.npy')[-1]
psi_12_hat = np.load('output_1by1_simulation/psi_12_burn.npy')[-1]
psi_13_hat = np.load('output_1by1_simulation/psi_13_burn.npy')[-1]
psi_21_hat = np.load('output_1by1_simulation/psi_21_burn.npy')[-1]
psi_22_hat = np.load('output_1by1_simulation/psi_22_burn.npy')[-1]
psi_23_hat = np.load('output_1by1_simulation/psi_23_burn.npy')[-1]
psi_31_hat = np.load('output_1by1_simulation/psi_31_burn.npy')[-1]
psi_32_hat = np.load('output_1by1_simulation/psi_32_burn.npy')[-1]
psi_33_hat = np.load('output_1by1_simulation/psi_33_burn.npy')[-1]
...
font = {'family': 'Times new Roman',
        ...
        'color': 'black',
        'size': 25}
xtick = np.linspace(0, Max_t, 8 + 1, endpoint=True)
...
lennode = shape_psi
xpsi = np.linspace(0, B_psi.shape[0] - 1, lennode)
...
plt.tight_layout()
plt.savefig('pic/1by1_PDE 1_True&Estimation-%s' % now.strftime('%y%m%d'), dpi=1200, bbox_inches='tight')
...
plt.legend(ncol=2, fontsize=18, bbox_to_anchor=(0.025, num2), loc=num3, borderaxespad=num4)
plt.tight_layout()
plt.savefig('pic/1by1_PDE 2_True&Estimation-%s' % now.strftime('%y%m%d'), dpi=1200, bbox_inches='tight')
...
plt.legend(ncol=2, fontsize=18, bbox_to_anchor=(0.025, num2), loc=num3, borderaxespad=num4)
plt.tight_layout()
plt.savefig('pic/1by1_PDE 3_True&Estimation-%s' % now.strftime('%y%m%d'), dpi=1200, bbox_inches='tight')
...
res_beta1 = np.load('output_1by1_simulation/beta1_burn.npy')
res_beta2 = np.load('output_1by1_simulation/beta2_burn.npy')
res_beta3 = np.load('output_1by1_simulation/beta3_burn.npy')
...
plt.tight_layout()
plt.savefig('pic/1by1_Beta1 trace_burn', dpi=1200, bbox_inches='tight')
plt.show()
...
plt.tight_layout()
plt.savefig('pic/1by1_Beta1 trace_steady', dpi=1200, bbox_inches='tight')
plt.show()
...
plt.tight_layout()
plt.savefig('pic/1by1_Beta2 trace_burn', dpi=1200, bbox_inches='tight')
plt.show()
...
plt.tight_layout()
plt.savefig('pic/1by1_Beta2 trace_steady', dpi=1200, bbox_inches='tight')
plt.show()
...
plt.tight_layout()
plt.savefig('pic/1by1_Beta3 trace_burn', dpi=1200, bbox_inches='tight')
plt.show()
...
plt.tight_layout()
plt.savefig('pic/1by1_Beta3 trace_steady', dpi=1200, bbox_inches='tight')
plt.show()